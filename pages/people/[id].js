...
import { get_all_item_ids, get_item_data, get_relationship_data } from '../../lib/data_firebase';

export async function getStaticPaths() {
    const paths = await get_all_item_ids();
    return {
        paths,
        fallback: false,
    };
...
export async function getStaticProps({ params }) {
    ...
    const relationship_data = await get_relationship_data(params.id);
